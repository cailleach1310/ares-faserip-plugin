  ...
  module Profile
    class CustomCharFields
      ...
      def self.get_fields_for_viewing(char, viewer)
        return { faserip: Faserip.build_web_char_data(char,viewer,false) }
      end
      ...
      def self.get_fields_for_chargen(char)
        return { faserip: Faserip.build_web_char_data(char,char,true),
                 cg_faserip: Faserip.build_web_chargen_info() }
      end
      ...
      def self.save_fields_from_chargen(char, chargen_data)
        Faserip.save_web_abilities(char, chargen_data)
        return []
      end
